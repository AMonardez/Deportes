...
class ValoracionesApi {
  ...
  static Future<bool> addValoracion(Valoracion v) async {
    ...
    //request.bodyFields = v.toJson() // No he probado
    request.bodyFields = {
      'id_deporte_en_zona': '30',
      'nombre_tipo_deporte': ' calistenia',
      'valorizaciones':
          ' [{"variable": "iluminacion", "puntuacion": 5}, {"variable": "variedad de maquinas", "puntuacion": 4}, {"variable": "estado maquinas", "puntuacion": 0}]',
      'id_usuario': ' 120'
    };
  ...
  static Future<List<Reporte>> getReportes(ZonaDeportiva zd) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception("Error de api: getReportes");
  }
}
