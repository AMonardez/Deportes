...
class MapaDeporteState extends State<MapaDeporte>{
  LatLng ubicacion = new LatLng(-29.923874957260825, -71.21416037734683);
  MapController mc= new MapController(location: LatLng(-29.923874957260825, -71.21416037734683));
  ...
  Widget build(BuildContext context) {
    //return Text("Hola");
    return MapLayoutBuilder(controller: mc, builder: (context, transformer){
      final homeLocation = transformer.fromLatLngToXYCoords(ubicacion);
      ...
      final centerMarkerWidget = _buildMarkerWidget(centerLocation, Colors.red);
